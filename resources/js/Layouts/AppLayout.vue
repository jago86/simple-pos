...
const showToasts = () => {
    if (page.props.flash.success) {
        toast.add({ severity: 'success', summary: '¡Éxito!', detail: page.props.flash.success, life: 5000 });
    }

    if (page.props.flash.error) {
        toast.add({ severity: 'error', summary: 'Hubo un problema', detail: page.props.flash.error, life: 5000 });
    }
};
</script>
...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 bg-[url('/images/bg-dark2.png')]">
                                ...
                                <div class="inline-flex items-center border-b-2" :class="{
                                    ...
                                    <Dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            ...
                                            <DropdownLink :href="route('sales.index') ">
                                                Ver
                                            </DropdownLink>
                                            <DropdownLink :href="route('pos.create') ">
                                                POS
                                            </DropdownLink>
                                        </template>
                                    </Dropdown>
            ...
            <!-- Page Heading -->
            <header v-if="$slots.header" class="bg-cyan-700 shadow">
